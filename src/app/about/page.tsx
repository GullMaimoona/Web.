...
export default function page() {
  return (
    <>
    <Home title='About'  src='https://researchsnipers.com/wp-content/uploads/2018/05/featured.jpg' />
    <Box >
      <Container maxW={1400}>
    ...
    <Box >
      <Container maxW={1400}>
        <Flex my='50px' px={{lg:'50px', base:'20px'}} gap='30px' display={{lg:'flex', base:'grid'}}>
           ...
           <RevealWrapper origin='left' delay={200} duration={1000} distance='500px' reset={true}>
           <Image mx='auto' src='/logo5.png' alt='Panaverse' width={450} height={280}/>
           </RevealWrapper>
           </Box>
        </Flex>
      </Container>
    ...
    <Box >
      <Container maxW={1400}>
        <Flex my='50px' px={{lg:'50px', base:'20px'}} gap='30px' display={{lg:'flex', base:'grid'}}>
           <Box flexBasis='50%' m='auto'>
           <RevealWrapper origin='left' delay={200} duration={1000} distance='500px' reset={true}>
            <Image mx='auto' src='/ZiaKhan.webp' alt='Zia Khan'/>
           </RevealWrapper>
           </Box>
           <Box flexBasis='50%'>
           <RevealList interval={60} delay={500} origin='right' duration={1000} distance='500px' reset={true} >
